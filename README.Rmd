...
qualité du sol dans les bassins versants agricoles au Maroc, avec un focus sur
le **Soil Organic Carbon (SOC)** comme indicateur de qualité environnementale.
...
-  **Modélisation** par Random Forest pour prédire le Soil Organic Carbon (SOC)
